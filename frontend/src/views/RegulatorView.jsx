...
export default function RegulatorView() {
  ...
  return (
    <section>
      <h2>Regulator &mdash; Dispensing & Stock Aggregation</h2>
      <p className="hint">
        DGDA-style view over aggregated dispensing events and inventory
        discrepancies per pharmacy (&sect;7.5.3). A pharmacy's expected stock
        auto-decrements on every on-chain dispense; a positive discrepancy
        against their reported physical count means drugs left the shelf
        without a matching prescription on the chain.
      </p>
